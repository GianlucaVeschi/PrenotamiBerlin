...
### Option 3: Run as Background Service (macOS/Linux)

For long-term automated operation, you can set it up as a system service.

**Using cron (runs at 7:00 AM daily):**
...
2. Add this line (replace path with your actual path):
   ```
   0 7 * * * cd /Users/gianluca.veschi@getyourguide.com/VScodeProjects/PrenotamiBerlin && /Users/gianluca.veschi@getyourguide.com/VScodeProjects/PrenotamiBerlin/venv/bin/python prenotami_bot.py >> scheduler.log 2>&1
   ```

**Using launchd (macOS):**

Create a file `~/Library/LaunchAgents/com.prenotami.bot.plist`:
...
<dict>
    <key>Label</key>
    <string>com.prenotami.bot</string>
    <key>ProgramArguments</key>
    <array>
        <string>/Users/gianluca.veschi@getyourguide.com/VScodeProjects/PrenotamiBerlin/venv/bin/python</string>
        <string>/Users/gianluca.veschi@getyourguide.com/VScodeProjects/PrenotamiBerlin/prenotami_bot.py</string>
    </array>
    ...
    <string>/Users/gianluca.veschi@getyourguide.com/VScodeProjects/PrenotamiBerlin</string>
    <key>StandardOutPath</key>
    <string>/Users/gianluca.veschi@getyourguide.com/VScodeProjects/PrenotamiBerlin/bot.log</string>
    <key>StandardErrorPath</key>
    <string>/Users/gianluca.veschi@getyourguide.com/VScodeProjects/PrenotamiBerlin/bot_error.log</string>
</dict>
</plist>
```
...
Then load it:
```bash
launchctl load ~/Library/LaunchAgents/com.prenotami.bot.plist
```
